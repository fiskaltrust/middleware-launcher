...
```jsonc
{
  ...
  "launcherDataFolder": "<launcherDataFolder>",             // string (default-windows: "C:/ProgramData/fiskaltrust.Launcher", default-linux: "/var/lib/fiskaltrust.Launcher", default-macos: "/Library/Application Support/fiskaltrust.Launcher")
...
| `--launcher-data-folder <launcher-data-folder>`               | Path to the launcher data folder.                                                                                | Windows: `"C:/ProgramData/fiskaltrust.Launcher"`<br/>Linux: `"/var/lib/fiskaltrust.Launcher"`<br/>MacOS: `"/Library/Application Support/fiskaltrust.Launcher"` |
