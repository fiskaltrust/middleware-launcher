...
namespace fiskaltrust.Launcher.Commands
{
    ...
    public static class CommonHandler
    {
            ...
            Func<CommonOptions, CommonProperties, O, S, Task<int>> handler) where S : notnull
        {
            ...
            try
            {
                clientEcdh = await LoadCurve(launcherConfiguration.CashboxId!.Value, launcherConfiguration.AccessToken!, launcherConfiguration.ServiceFolder!, launcherConfiguration.UseOffline!.Value, launcherConfiguration.UseLegacyDataProtection!.Value);
