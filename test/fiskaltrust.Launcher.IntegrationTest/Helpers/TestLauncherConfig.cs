...
namespace fiskaltrust.Launcher.IntegrationTest
{
    public static class TestLauncherConfig
    {
        public static LauncherConfiguration GetTestLauncherConfig
            (Guid? cashboxId = null, string? accessToken = null, string? serviceFolder = null, string? packageCache = null)
        {
            var launcherConfiguration = new LauncherConfiguration()
            {
                ServiceFolder = serviceFolder ?? AppDomain.CurrentDomain.BaseDirectory,
                ...
                Sandbox = true,
                PackageCache = packageCache ?? "./cache"
            };
